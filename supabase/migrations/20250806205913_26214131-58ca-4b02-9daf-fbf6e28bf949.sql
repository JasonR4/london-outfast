-- Add VAT settings to global settings with proper user context
INSERT INTO global_settings (setting_key, setting_type, setting_value, is_active, created_by, updated_by)
VALUES (
  'vat_settings',
  'tax',
  '{"vat_rate": 20, "vat_enabled": true, "vat_inclusive": false}'::jsonb,
  true,
  '920f996a-5909-4313-9b00-6511c9cabff4'::uuid,
  '920f996a-5909-4313-9b00-6511c9cabff4'::uuid
)
ON CONFLICT (setting_key) DO UPDATE SET
setting_value = '{"vat_rate": 20, "vat_enabled": true, "vat_inclusive": false}'::jsonb,
updated_at = now(),
updated_by = '920f996a-5909-4313-9b00-6511c9cabff4'::uuid;
