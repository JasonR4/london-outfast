-- Add descriptions to remaining general industry pages - Part 1
...
WHERE slug = 'startups' AND page_type = 'general';
...
WHERE slug = 'healthcare' AND page_type = 'general';
...
WHERE slug = 'retail' AND page_type = 'general';
...
WHERE slug = 'events' AND page_type = 'general';
...
WHERE slug = 'beauty' AND page_type = 'general';