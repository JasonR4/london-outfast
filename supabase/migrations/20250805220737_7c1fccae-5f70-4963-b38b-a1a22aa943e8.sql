-- Add descriptions to remaining general industry pages - Part 2
...
WHERE slug = 'agencies' AND page_type = 'general';
...
WHERE slug = 'property' AND page_type = 'general';
...
WHERE slug = 'travel' AND page_type = 'general';
...
WHERE slug = 'construction' AND page_type = 'general';
...
WHERE slug = 'technology' AND page_type = 'general';