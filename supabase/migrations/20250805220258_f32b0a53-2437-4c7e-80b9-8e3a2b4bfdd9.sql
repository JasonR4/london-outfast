-- Update remaining industry pages with text blocks (part 2)
...
WHERE slug = 'food' AND page_type = 'industry';
...
WHERE slug = 'government' AND page_type = 'industry';
...
WHERE slug = 'entertainment' AND page_type = 'industry';

-- Recruitment & Careers (mapping to existing industries if applicable)
UPDATE content_pages 
SET content = jsonb_set(
  content,
  '{description}',
...
WHERE slug = 'recruitment' AND page_type = 'industry';
...
WHERE slug = 'finance' AND page_type = 'industry';
...
WHERE slug = 'fashion' AND page_type = 'industry';