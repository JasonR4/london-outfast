...
INSERT INTO public.media_formats (format_name, format_slug, description, dimensions) 
VALUES 
  ('48 Sheet Billboard', '48-sheet-billboard', 'Large format billboard advertising', '6m x 3m'),
  ('6 Sheet Poster', '6-sheet-poster', 'Standard roadside poster', '1.8m x 1.2m'),
  ('Bus Stop Poster', 'bus-stop-poster', 'Transit advertising at bus stops', '1.2m x 1.8m'),
  ('Digital Billboard', 'digital-billboard', 'Digital LED billboard advertising', '6m x 3m');