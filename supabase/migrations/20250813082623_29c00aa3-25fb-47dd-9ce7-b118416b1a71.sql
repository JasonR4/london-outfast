...
INSERT INTO public.seo_pages (page_slug, meta_title, meta_description, keywords, h1_heading, h2_headings, focus_keyword, london_locations, schema_markup)
VALUES (
  '/',
  ...
  ARRAY['London Out-of-Home advertising', 'OOH media buying', 'TfL advertising', 'London Underground ads', 'digital roadside advertising', 'bus advertising London', 'taxi advertising', 'National Rail advertising', 'retail advertising', 'airport advertising', 'street furniture advertising', 'programmatic DOOH', 'ambient advertising'],
  'London''s Fastest Out-of-Home Media Buying Specialists',
  ARRAY['Why Choose Media Buying London', 'Our OOH Media Services', 'Get Started Today'],
  'London Out-of-Home advertising',
  ARRAY['Greater London', 'Central London', 'London Underground', 'London Transport'],
  jsonb_build_object(
