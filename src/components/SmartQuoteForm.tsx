                          ...
                          return (
                            <div className="bg-muted/30 p-4 rounded-lg border border-border">
                              <h4 className="font-medium text-sm mb-3">
                                Media Rate Card - {totalQuantity} Units - {selectedLocations.length} Location{selectedLocations.length > 1 ? 's' : ''} × {selectedPeriods.length} Period{selectedPeriods.length > 1 ? 's' : ''}
                              </h4>
